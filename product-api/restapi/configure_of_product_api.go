...
import (
	...
	"product-api/restapi/operations"
	"product-api/restapi/operations/products"
)

//go:generate swagger generate server --target ../../product-api --name OfProductAPI --spec ../swagger.yaml --principal any --exclude-main

func configureFlags(api *operations.OfProductAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
	_ = api
}

func configureAPI(api *operations.OfProductAPIAPI) http.Handler {
	...
	if api.ProductsAddProductHandler == nil {
		api.ProductsAddProductHandler = products.AddProductHandlerFunc(func(params products.AddProductParams) middleware.Responder {
			_ = params
