...
// an rpc based service called GetRate using a RateRequest message to return a RateResponse
...
const file_currency_proto_rawDesc = "" +
	...
	"\bCurrency\x128\n" +
	"\aGetRate\x12\x15.currency.RateRequest\x1a\x16.currency.RateResponseB\x1aZ\x18protos/currency;currencyb\x06proto3"
